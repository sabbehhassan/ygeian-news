    ...
    <>
      <div className="flex flex-col gap-[20px] w-full max-w-[1080px] mx-auto px-4">
        ...
        <p className="text-[#375E6C] text-[16px]">
          ...
          hope for more effective cancer treatments beyond traditional
        ...
        {/* Desktop Only: AI Content Summarizer */}
        {/* <div className="hidden lg:flex bg-white w-full h-[94px] justify-center items-center mt-[-10px]">
          <div className="bg-[#43B3E5] text-white w-[70%] rounded-full h-[50.18px] flex justify-center items-center gap-2">
